...
st.set_page_config(page_title='HDB Flat Resale Price Predictor',page_icon='house',initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Nithesh Goutham M'})
...
if selected == "Home":
    title_text = '''<h1 style='font-size: 30px;text-align: center; color:orange;'>  Singapore Resale Flat Prices Predicting </h1>'''
    ...
    with st.container():
        ...
        with cl:
                ...
                st.markdown('''<h6 style='color:#D0D3D4;font-size:18px'>An outstanding organisation creating endearing homes 
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Nithesh Goutham , a BE graduate with a keen interest in data science and analytics.
